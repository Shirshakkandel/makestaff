  ...
  return (
    <section className="mt-[18px] container-custom lg:mt-[50px]">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex cursor-pointer items-center justify-center rounded-full border-[1px] border-[#00000066] md:h-7 md:w-7">
          <Image
            src={Closed.src}
            width={30}
            height={30}
      ...
      <section className=" sm:w-[70%] sm:min-w-[493px] lg:mx-0 ">
        ...
        <div className="mt-7 text-[19px] font-[400] lg:mt-12">
          ...
          <section className="mt-7 flex flex-col gap-5 lg:mt-16">
            ...
            <button className="w-full gap-1 rounded-[30px] bg-[#FFECEC] py-4 flex-center  hover:opacity-70">
              <Image width={16} height={16} src={Microsoft.src} alt="google" />
              <span className="text-[14px]">Login With Microsoft</span>
            </button>
          </section>
        </div>
